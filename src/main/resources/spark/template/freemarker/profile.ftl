   ...
   <body>
      ...
      <div class="container">
         <div class="row row-offcanvas row-offcanvas-right">
			...
			<#else>
            <#if error><div class="alert alert-danger" role="alert"><i class="fa fa-times"></i> <b>Ошибка!</b> Вы оставили некоторые поля пустыми. Данные не были изменены.</div></#if>
            </#if>
            <div>
               <div class="modal-body">
                  <form action="/profile/edit" method="get" class="form-horizontal">
                     <div class="form-group">
                        <label for="inputEmail" class="col-sm-2 profilelabel">E-mail</label>
                        <div class="col-sm-10">
                            ${user.email}
                        </div>
                     </div>
                     <div class="form-group">
                        <label for="inputSurname" class="col-sm-2 profilelabel">Фамилия</label>
                        <div class="col-sm-10">
                            ${user.surname}
                        </div>
                     </div>
                     <div class="form-group">
                        <label for="inputName" class="col-sm-2 profilelabel">Имя</label>
                        <div class="col-sm-10">
                            ${user.name}
                        </div>
                     </div>
                     <div class="form-group">
                        <label for="inputPatronymic" class="col-sm-2 profilelabel">Отчество</label>
                        <div class="col-sm-10">
                            ${user.patronymic}
                        </div>
                     </div>
                     <div class="form-group">
                        <label for="inputBirthday" class="col-sm-2 profilelabel">Дата рождения</label>
                        <div class="col-sm-10">
                            ${user.birthday}
                        </div>
                     </div>
                     <div class="form-group">
                        <label for="inputPhone" class="col-sm-2 profilelabel">Контактный телефон</label>
                        <div class="col-sm-10">
                            ${user.phone}
                        </div>
                     </div>
                     <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-2">
                           <button type="submit" class="btn btn-primary">Изменить свои данные</button>
                        </div>
                     </div>
                  </form>
               </div>
