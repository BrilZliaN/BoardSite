   ...
   <body>
      ...
      <div class="container">
         <div class="row row-offcanvas row-offcanvas-right">
            ...
            <hr>
			<#if success>
			<div class="alert alert-success" role="alert"><i class="fa fa-check"></i> <b>Успех! </b> Ваша заявка принята. Вы получите обратный звонок в ближайшее время.</div>
			<#else>
            <div>
               <div class="modal-body">
                  <form action="/book/${task.id}" method="post" class="form-horizontal">
                     <div class="form-group">
                        <label for="inputTitle" class="col-sm-2 profilelabel">Услуга</label>
                        <div class="col-sm-10">
                            ${task.title}
                        </div>
                     </div>
                     <div class="form-group">
                        <label for="inputBudget" class="col-sm-2 profilelabel">Цена</label>
                        <div class="col-sm-10">
                            ${task.budget}
                        </div>
                     </div>
